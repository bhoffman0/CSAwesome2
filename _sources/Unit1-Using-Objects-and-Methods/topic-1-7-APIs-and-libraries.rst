...
.. dragndrop:: API_vocab_match
    ...
    :match_2: A collection of related classes organized to be imported into your code|||package
    :match_3: A specification that tells the programmer how to use classes in a library|||API
    :match_4: The building blocks of Java and object-oriented programming|||class
...
.. figure:: Figures/turtleOOD.png
    ...
    Figure 1: Turtle Attributes and Behaviors
...
.. mchoice:: turtle_type
   ...
   :answer_d: method
   :correct: a
   :feedback_a: Yes, Turtle is a class that defines the data and behaviors for all turtles.
   :feedback_b: yertle is an object of type Turtle.
...
.. mchoice:: type_turn_right
   ...
   :feedback_c: An attribute is something the object knows about itself.
   :feedback_d: A behavior or method is something an object can do like turn right.
...
.. image:: Figures/turtleForwardLeftForward.png
    :width: 200
    :align: left
