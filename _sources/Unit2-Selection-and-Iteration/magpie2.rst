...
You can also run a version of the `Magpie lab on replit.com <https://firewalledreplit.com/@BerylHoffman/Magpie-ChatBot-Lab-v2#Main.java>`_ that uses the Scanner class for input so that you can type in your own input to interact with it.
...
Here is the actual code for the `Magpie lab on replit.com <https://firewalledreplit.com/@BerylHoffman/Magpie-ChatBot-Lab-v2#Main.java>`_.  It uses the ``Scanner`` class to read input from the user.  The ``Scanner`` class is not on the AP CSA exam. You can log in to replit.com and use this code and change it to do this lab.
